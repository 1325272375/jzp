...
<div class="container-fluid">
  <div class="row-fluid">
    ...
    <form action="${pageContext.request.contextPath}/ShowAllTeacherServlet" method="post">
      <div class="row">
        <div class="mb-md-5">
          <label for="account" >账号:</label>
          <input type="text"  class="inputText" placeholder="请输入账号" id="account" name="account">
    ...
    <a href="${pageContext.request.contextPath}/man/addTeacher.jsp">添加老师</a>
        ...
        <c:forEach items="${teas}"  var="tea">
          <tr>
            ...
            <td>
              ...
              <a  href="${pageContext.request.contextPath}/man/updateTeacher.jsp?id=${tea.id}">修改</a>
              <a href="${pageContext.request.contextPath}/DelTeaServlet?id=${tea.id}">删除</a>
