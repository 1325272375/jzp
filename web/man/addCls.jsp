...
<div class="container mt-3">
  <h2>添加班级数据</h2>
  <form action="${pageContext.request.contextPath}/AddClsServlet" method="post">
    <div class="mb-3 mt-3">
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="bname" placeholder="请输入班级名称" name="bname" required>
    </div>
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="pro" placeholder="请输入班级专业"  name="pro" required>
    </div>
