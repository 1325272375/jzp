...
@WebServlet("/UpdateTeacherSMServlet")
public class UpdateTeacherSMServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("teaD/myMes.jsp");
