...
@WebServlet("/UpdateStuMesServlet")
public class UpdateStuMesServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int a=new LoginServiceImpl().updateStu(pwd,phone,adress,account);
        if(a==1){
        ...
        RequestDispatcher rd = request.getRequestDispatcher("stu/myMes.jsp");
